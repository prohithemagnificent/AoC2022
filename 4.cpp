...
int main(){
    ...
    for (const std::string& s : v){
        ...
        int beg1 = std::stoi(matchResults.str(1));
        int end1 = std::stoi(matchResults.str(2));
        int beg2 = std::stoi(matchResults.str(3));
        int end2 = std::stoi(matchResults.str(4));

        if ((beg1 >= beg2 && beg1 <= end2 && end1 >= beg2 && end1 <= end2) ||
            (beg2 >= beg1 && beg2 <= end1 && end2 >= beg1 && end2 <= end1)){                
                ret++;
        }
